...
public class TwitterAuthenticator {
	...
	public synchronized HttpRequestFactory getAuthorizedHttpRequestFactory() throws org.interview.oauth.twitter.TwitterAuthenticationException {
		if (factory != null) {
			return factory;
		}
		...
		try {
			...
			throw new org.interview.oauth.twitter.TwitterAuthenticationException("Unable to aquire temporary token: " + e.getMessage(), e);
		}
